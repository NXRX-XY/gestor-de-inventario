...
$sql = "DELETE FROM entrega_ont WHERE $opcion = ?";
...
if (mysqli_affected_rows($cone) > 0) {
    ...
    echo '<script>alert("La guía que intenta eliminar no existe."); window.location.href = "../html-admin/eliminar_entrega_ont.php";</script>';
    exit;
}

mysqli_stmt_close($stmt);

echo '<script>alert("Los datos se han eliminado correctamente."); window.location.href = "../html-admin/eliminar_entrega_ont.php";</script>';
