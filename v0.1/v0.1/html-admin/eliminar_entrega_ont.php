...
<head>
  ...
  <title>Eliminar entrega ont</title>
...
<h5 class="card-title fw-semibold mb-4" style="text-align:center; margin: 0 auto;">Eliminar entrega ont</h5>
<form id="formEliminar" method="post" action="../php-admin/eliminar_entrega_ont.php" class="card" style="width: 90%; height: auto; position: relative; display: flex; flex-direction: column; align-items: center; left: 4%; border: 4px solid skyblue; border-radius: 5px;">        
