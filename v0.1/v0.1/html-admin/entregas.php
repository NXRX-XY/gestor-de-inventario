    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
            ...
            <form method="post" action="../php-admin/entregas.php" class="card" style="width: 90%; height: auto; position: relative; display: flex; flex-direction: column; align-items: center; left: 4%; border: 4px solid skyblue; border-radius: 5px;">        
    <div class="container">
        <label for="tipo" class="asig">Devolucion de:</label>
                      ...
                      <table id="miTabla" class="miTabla">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><input type="text" style="width: 70px;" name="cantidad[]"></td>
                            ...
                            <td><input type="text" name="codigo[]" style="width: 90px;" oninput="fillDescription(this)"></td>
                            <td>
...
.item-cell {
  width: 10%;
              ...
              <button type="submit" class="btn btn-danger m-1" style="position: relative; left: 45%; transform: translateX(-50%); bottom: -20px; font-size: 1.3rem; background-color: greenyellow; border-color: greenyellow;">Enviar</button>
                </section>
