    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
            <h5 class="card-title fw-semibold mb-4" style="text-align:center; margin: 0 auto;">Ingreso de ONT</h5>
            <form method="post" action="../php-admin/entrada_ont.php" class="card" style="width: 90%; height: auto; position: relative; display: flex; flex-direction: column; align-items: center; left: 4%; border: 4px solid skyblue; border-radius: 5px;" enctype="multipart/form-data">       
    <style>
        .container {
            display: flex;
            align-items: center;
...
<input id="ctn_id" name="ctn_id" style="width: 100%; height: 40px; border-radius: 20px; overflow: hidden; font-size: 1.5rem; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3);" required>
<br><br>
<h2 style="font-size: 1.3rem; margin-bottom: 1rem;">PROD ID</h2>
<input id="prod_ide" name="prod_id" style="width: 100%; height: 40px; border-radius: 20px; overflow: hidden; font-size: 1.5rem; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3);" required>
<br><br>
...
<input id="numero_serial"  name="numero_serial" style="width: 100%; height: 40px; border-radius: 20px; overflow: hidden; font-size: 1.5rem; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3);" required>
<br><br>
