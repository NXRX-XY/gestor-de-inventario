...
function agregarFila() {
  ...
  unidadCell.innerHTML = '<select name="unidad[]"><option value="unidad">Unidad</option><option value="metros">Metros</option><option value="centimetros">Centimetros</option><option value="par">Par</option><option value="paquete">Paquete</option></select>';

  var codigoCell = newRow.insertCell(3);
  codigoCell.innerHTML = '<input type="text" name="codigo[]" style="width: 90px;" oninput="fillDescription(this)" required>';

  var descripcionCell = newRow.insertCell(4);
  descripcionCell.innerHTML = '<div class="autocomplete"><select style="width: 100px;" name="descripcion[]" oninput="fillCodigo(this)" onkeyup="fillAutocomplete(this, \'codigo[]\')" onchange="seleccionarDescripcion(this)"><option value="">Seleccione</option><!-- Agrega las opciones restantes aquí --></select><div class="autocomplete-list" id="descripcionAutocomplete"></div></div>';
  var provedorCell = newRow.insertCell(5);
  provedorCell.innerHTML = '<input type="text" style="width: 70px;" name="provedor[]" </input>';
...
<body>
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title fw-semibold mb-4" style="text-align:center; margin: 0 auto;">Ingreso de materiales</h5>
              <form method="post" action="../php-admin/aprovisionar.php"  class="card" style="width: 90%; height: auto; position: relative; display: flex; flex-direction: column; align-items: center; left: 4%; border: 4px solid skyblue; border-radius: 5px;">
                <section class="card-body p-4" style="width: 80%; max-width: 500px;">
                  <h2 style="font-size: 1.3rem; margin-bottom: 1rem;">Número de guía</h2>
                  <input id="numero-de-guia" name="numero_de_guia" style="width: 100%; height: 40px; border-radius: 20px; overflow: hidden; font-size: 1.5rem; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3);" required>
                  <div style="height: 100%; min-height: 100%; width: 120%;">
                      ...
                      <table id="miTabla" class="miTabla">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><select name="unidad[]"><option value="unidad">Unidad</option><option value="metros">Metros</option><option value="centimetros">Centimetros</option><option value="par">Par</option><option value="paquete">Paquete</option></select></td>
                            <td><input type="text" name="codigo[]" style="width: 90px;" oninput="fillDescription(this)" required></td>
                                     <td>
  <div class="autocomplete">
  <select style="width: 100px;" name="descripcion[]" oninput="fillCodigo(this)" onkeyup="fillAutocomplete(this, 'codigo[]')" onchange="seleccionarDescripcion(this)">
  ...
  <div class="autocomplete-list" id="descripcionAutocomplete"></div>
                            ...
                            <td><input type="text" style="width: 70px;" name="provedor[]"></td>
                          </tr>
                        </tbody>
                      </table>
                      <style>
...
.item-cell {
  width: 10%;
              ...
              <h5 class="card-title fw-semibold mb-4" style="text-align:center; margin: 0 auto;">Consultas de Ingreso</h5>
              <form method="post" action="../php-admin/consulta-aprovision.php" target="_blank" class="card mb-0" style="width: 90%; height: 25%;position: relative; display: flex; flex-direction: column; align-items: center; left: 4%; border: 4px solid skyblue; border-radius: 5px;">
                <section class="card-body p-4" style="display: flex; flex-direction: column; align-items: center; width: 100%;">
                    ...
                    <select name="opcion" id="opcion" style="width: 90%; height: 40px; border-radius: 20px; overflow: hidden; font-size: 1.5rem; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3);">
                        <option name="opcion1" value="opcion1">Código</option>
                        <option name="opcion2" value="opcion2">Material</option>
                        <option name="opcion3" value="opcion3">Fecha</option>
                    </select>
                </section>
                <button type="submit" class="btn btn-outline-danger m-1" style="font-size: 1.3rem; background-color: greenyellow; border-color: greenyellow; color: white;">Enviar</button>
            </form>
