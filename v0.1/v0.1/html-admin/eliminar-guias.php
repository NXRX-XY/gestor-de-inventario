...
<h5 class="card-title fw-semibold mb-4" style="text-align:center; margin: 0 auto;">Eliminar guías</h5>
<form id="formEliminar" method="post" action="../php-admin/eliminar-guias.php" class="card" style="width: 90%; height: auto; position: relative; display: flex; flex-direction: column; align-items: center; left: 4%; border: 4px solid skyblue; border-radius: 5px;">        
    <section class="card-body p-4" style="width: 80%; max-width: 500px;">
        <h2 style="font-size: 1.3rem; margin: 1rem 0;">N° de guía:</h2>
        <input id="eliminar" name="eliminar" type="number" style="width: 90%; height: 40px; border-radius: 20px; overflow: hidden; font-size: 1.5rem; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3);" required>
        ...
        <select name="opcion" id="tipo-asignacion" style="margin-top: 40px;width: 90%; height: 40px; border-radius: 20px; overflow: hidden; font-size: 1.5rem; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3);">
            ...
            <option value="uniformes">Asignacion de uniforme</option>
        </select>
