...
<body>
  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
      ...
      <div>
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar="">
          ...
          <li class="nav-small-cap">
            ...
            <li class="sidebar-item">
              <a class="sidebar-link" href="../html-admin/entrega_mesh.php" aria-expanded="false">
                <span>
                   <i class="ti ti-search"></i>
                </span>
                <span class="hide-menu">Entrega mesh</span>
              </a>
            </li>
            <li class="sidebar-item">
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
            <h5 class="card-title fw-semibold mb-4" style="text-align:center; margin: 0 auto;">Entrega de Mesh</h5>
    ...
    <h2 style="font-size: 1.3rem; margin-bottom: 1rem;">P/N ID</h2>
