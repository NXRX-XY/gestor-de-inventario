    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
           <div class="card-body">
                  <h5 class="card-title fw-semibold mb-4" style="text-align:center; margin: 0 auto;">Consultar entrada ont</h5>
                  <form method="post" target="_blank" action="../php-admin/consulta_entrada_ont.php" class="card mb-0" style="width: 90%; height: 25%; position: relative; display: flex; flex-direction: column; align-items: center; left: 4%; border: 4px solid skyblue; border-radius: 5px;">
