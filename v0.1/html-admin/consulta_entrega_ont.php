  ...
  <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full"
    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
                  <h5 class="card-title fw-semibold mb-4" style="text-align:center; margin: 0 auto;">Consultar entrega ont</h5>
                  <form method="post" target="_blank" action="../php-admin/consulta_entrega_ont.php" class="card mb-0" style="width: 90%; height: auto; position: relative; display: flex; flex-direction: column; align-items: center; left: 4%; border: 4px solid skyblue; border-radius: 5px;">
    <section class="card-body p-4" style="display: flex; flex-direction: column; align-items: center; width: 100%;">
        ...
        <select name="opcion" id="opcion" style="width: 90%; height: 40px; border-radius: 20px; overflow: hidden; font-size: 1.5rem; box-shadow: 0px 2px 5px rgba(0, 0, 0, 0.3);">
            <option value="ctn">CTN ID</option>
            <option value="prod">PROD ID</option>
