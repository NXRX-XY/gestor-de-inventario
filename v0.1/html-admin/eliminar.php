    ...
    <div class="body-wrapper">
      ...
      <div class="container-fluid">
        <div class="container-fluid">
          <div class="card">
            <div class="card-body">
            <h5 class="card-title fw-semibold mb-4" style="text-align:center; margin: 0 auto;">Eliminar usuario</h5>
            <form method="post" action="../php-admin/eliminar.php" class="card" style="width: 90%; height: auto; position: relative; display: flex; flex-direction: column; align-items: center; left: 4%; border: 4px solid skyblue; border-radius: 5px;">        
...
?>
              ...
              <button type="submit" class="btn btn-danger m-1" style="position: relative; left: 50%; transform: translateX(-50%); bottom: -20px; font-size: 1.3rem; background-color: red; border-color: red;">Eliminar usuario</button>
                </section>
              </form>
